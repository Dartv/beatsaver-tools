import { Button, Checkbox, TextInputField, Pane, FormField, TextareaField, SegmentedControl } from 'evergreen-ui';
...
const downloadOptions = Object.values(DownloadOption).map(option => ({ label: option, value: option }));
